        ...
        <div className='bg-base-300 p-6 space-y-8 rounded-xl'>
          ...
          <div className='flex flex-col items-center gap-4'>
            <div className='relative'>
              ...
              ${isUpdatingProfile ? "animate-pulse pointer-eventws-none" : ""}
              `}
              >
          ...
          <div className='mt-6 bg-base-300 rounded-xl p-6'>
            ...
            <div className='space-y-3 text-sm'>
              <div className='flex items-center justify-between py-2 border-b border-zinc-700'>
                ...
                <span className='text-md text-black-100'>{authUser.createdAt?.split("T")[0]}</span>
              </div>
              <div className='flex items-center justify-between py-2'>
                <span>Account Status</span>
                <span className='text-md text-green-500'>Active</span>
              </div>
            </div>
          </div>
        </div>
